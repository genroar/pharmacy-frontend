...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none !focus:bg-blue-100 !focus:text-blue-900 !hover:bg-blue-50 !hover:text-blue-800 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 !transition-colors !duration-200",
      className
    )}
    {...props}
  >
